...
IMPORTANT: This specific script is depreciated and a more recent version of this script and its main output (fisher_counts.csv) is available on the noaa-pifsc github here:

[Hawaii_Fisher_List](https://github.com/noaa-pifsc/Hawaii_Fisher_List)
